...
Run the server: `npm run styleguide`

## Templates and Tools
As the name suggests `templates-and-tools` directory exists for the sole purpose of assisting the developer.  Nothing in it is required for the code to function.

Follow this [link](./templates-and-tools/README.md) to go there.


***EVERYTHING BELOW THIS LINE WAS GENERATED BY THE create-react-app cli
-----------------------------------------------------------------------
